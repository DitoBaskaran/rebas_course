    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card-modern p-4 p-md-5 animate-scale-in">
                ...
                <?php echo form_open('forum/create/' . $course->id, array('class' => 'd-flex flex-column gap-3')); ?>
                    <div>
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <a href="<?php echo base_url('forum/index/' . $course->id); ?>" class="btn btn-outline-secondary px-4 py-2.5"><?php echo t('Batal', 'Cancel'); ?></a>
                    </div>
                <?php echo form_close(); ?>
            </div>
        </div>
