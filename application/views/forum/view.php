        ...
        <div class="col-lg-8">
                    ...
                    <div class="flex-fill">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <div>
                                ...
                                <small class="text-secondary"><?php echo htmlspecialchars($discussion->user_name); ?> · <?php echo time_elapsed($discussion->created_at); ?></small>
                            </div>
                        </div>
                ...
                <?php foreach ($replies as $reply): ?>
                    <div class="card-flat p-4 d-flex gap-3 <?php echo $reply->is_best_answer ? 'border-success border-start border-4' : ''; ?>" id="reply-<?php echo $reply->id; ?>">
                        ...
                        <div class="flex-fill">
                            ...
                            <?php if ($discussion->user_id == $this->session->userdata('user_id') && !$reply->is_best_answer && !$discussion->is_best_answer): ?>
            ...
            <div class="card-flat p-4">
                ...
                <?php echo form_open('forum/reply/' . $discussion->id); ?>
                    ...
                    <button type="submit" class="btn btn-primary btn-sm px-4"><?php echo t('Kirim', 'Send'); ?></button>
                <?php echo form_close(); ?>
            </div>
        </div>
    </div>
