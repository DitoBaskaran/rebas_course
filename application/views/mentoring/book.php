        ...
        <div class="col-lg-8">
            <div class="border rounded-3 p-4" style="border-color: #e5e5e5; border-radius: 12px;">
                ...
                <?php echo form_open('mentoring/confirm-booking'); ?>
                            ...
                            <div class="d-flex flex-column gap-2">
                                <?php foreach ($balances as $bal): ?>
                                    <label class="d-flex justify-content-between align-items-center p-3 rounded-3" style="border: 1px solid #e5e5e5; cursor: pointer; transition: all 0.15s;">
                                        <input type="radio" name="balance_id" value="<?php echo $bal->id; ?>" class="me-2" required style="accent-color: #009688;">
                    ...
                    <button type="submit" class="btn py-3 fw-bold rounded-pill w-100" style="background: #009688; color: #111827; font-size: 0.9rem;" <?php echo empty($balances) ? 'disabled' : ''; ?>>
