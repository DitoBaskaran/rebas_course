...
<div class="container-fluid py-4" style="padding-top: 0px !important; max-width: 1100px;">
    ...
    <div class="mn-ai-card border rounded-4 p-3 mb-4" style="border-color:#e7e5e4; border-radius:16px; background:linear-gradient(135deg,#0D1830 0%,#1e3a5f 55%,#009688 130%); position:relative; overflow:hidden;">
        ...
        <div class="d-flex align-items-center gap-3 mb-2 position-relative">
            ...
            <div>
                <h6 class="fw-bold mb-0" style="color:#fff; font-size:0.92rem;"><?php echo t('Konsultasi AI', 'AI Consultation'); ?></h6>
                <small style="color:rgba(230,235,239,0.75); font-size:0.72rem;"><?php echo t('Ceritakan masalahmu, AI rekomendasikan mentor yang cocok', 'Tell us your problem, AI recommends the right mentor'); ?></small>
            </div>
        </div>
        ...
        <div id="aiResult" class="mt-3 position-relative" style="display:none;"></div>
        <div id="aiLoading" class="text-center py-3 position-relative" style="display:none;">
            <div class="spinner-border spinner-border-sm me-2" style="color:#FBBF24;" role="status"></div>
            <span style="color:rgba(230,235,239,0.85); font-size:0.8rem;"><?php echo t('AI sedang menganalisis & mencari mentor yang tepat...', 'AI is analyzing & finding the right mentor...'); ?></span>
        </div>
    </div>
