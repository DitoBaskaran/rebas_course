            ...
            <div class="col-md-6 col-lg-4">
                <div class="border rounded-3 h-100 d-flex flex-column" style="border-color: #e7e5e4; border-radius: 12px; transition: all 0.15s; position: relative; background: #fff;">
                    ...
                    <div class="position-relative overflow-hidden" style="aspect-ratio: 16/9; border-radius: 12px 12px 0 0;">
                        ...
                        <!-- Remove button -->
                        <button onclick="toggleWishlist('<?php echo $c->slug; ?>')" class="btn d-flex align-items-center justify-content-center position-absolute" style="top: 8px; right: 8px; width: 30px; height: 30px; border-radius: 50%; background: rgba(255,255,255,0.9); border: none; color: #009688; padding: 0; cursor: pointer;">
