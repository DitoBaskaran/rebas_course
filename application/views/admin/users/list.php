<div class="container-fluid py-4" style="max-width: 1400px;">
    <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between mb-4 gap-3">
        <div>
            <div class="text-uppercase fw-bold mb-0" style="color: #f97316; font-size: 0.7rem; letter-spacing: 0.08em;"><?php echo t('Pengguna', 'Users'); ?></div>
    ...
    <div class="border rounded-3" style="border-color: #e7e5e4; border-radius: 12px; overflow: hidden;">
        <div class="table-responsive p-0">
            <table class="table table-hover mb-0 align-middle" style="font-size: 0.8rem;" id="userTable">
                <thead>
                    <tr>
                        <th class="fw-semibold text-uppercase" style="color: #78716c; font-size: 0.68rem; border-color: #e7e5e4; padding: 0.7rem 1rem; background: #fafaf9; letter-spacing: 0.05em; width: 30%;"><?php echo t('Nama', 'Name'); ?></th>
                        <th class="fw-semibold text-uppercase d-none d-md-table-cell" style="color: #78716c; font-size: 0.68rem; border-color: #e7e5e4; padding: 0.7rem 1rem; background: #fafaf9; letter-spacing: 0.05em;">Email</th>
                        <th class="fw-semibold text-uppercase" style="color: #78716c; font-size: 0.68rem; border-color: #e7e5e4; padding: 0.7rem 1rem; background: #fafaf9; letter-spacing: 0.05em; width: 18%;"><?php echo t('Role', 'Role'); ?></th>
                        <th class="fw-semibold text-uppercase" style="color: #78716c; font-size: 0.68rem; border-color: #e7e5e4; padding: 0.7rem 1rem; background: #fafaf9; letter-spacing: 0.05em; width: 12%;"><?php echo t('Status', 'Status'); ?></th>
                        <th class="fw-semibold text-uppercase d-none d-lg-table-cell" style="color: #78716c; font-size: 0.68rem; border-color: #e7e5e4; padding: 0.7rem 1rem; background: #fafaf9; letter-spacing: 0.05em; width: 15%;"><?php echo t('Terdaftar', 'Registered'); ?></th>
                        <th class="fw-semibold text-uppercase text-center" style="color: #78716c; font-size: 0.68rem; border-color: #e7e5e4; padding: 0.7rem 1rem; background: #fafaf9; letter-spacing: 0.05em; width: 80px;"><?php echo t('Aksi', 'Action'); ?></th>
                    </tr>
                </thead>
                <tbody>
                    <?php if (empty($users)): ?>
                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            <td style="border-color: #f0eeeb; padding: 0.65rem 1rem; font-weight: 700; color: #1c1917; font-size: 0.78rem;">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="d-flex align-items-center justify-content-center rounded-circle fw-bold text-white flex-shrink-0" style="width: 32px; height: 32px; background: #f97316; font-size: 0.72rem;"><?php echo strtoupper(substr($u->name, 0, 1)); ?></span>
                                    <div class="min-w-0">
                            ...
                            <td style="border-color: #f0eeeb; padding: 0.65rem 1rem; text-align: center;">
                                <a href="<?php echo base_url('admin/edit_user/' . $u->id); ?>" class="btn btn-sm rounded-pill px-2 d-inline-flex align-items-center" style="background: #f97316; color: #fff; font-size: 0.68rem;" title="<?php echo t('Edit', 'Edit'); ?>">
