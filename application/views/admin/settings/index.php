<div class="container-fluid py-4" style="max-width: 1400px;">
    ...
    <div class="d-flex gap-2 mb-4 flex-wrap">
        ...
        <a class="px-3 py-2 rounded-pill fw-semibold text-decoration-none d-inline-flex align-items-center gap-1" style="font-size: 0.8rem; background: <?php echo $active_group === 'whatsapp' ? '#0D1830' : '#E6EBEF'; ?>; color: <?php echo $active_group === 'whatsapp' ? '#fff' : '#57534e'; ?>;" href="<?php echo base_url('admin/settings/whatsapp'); ?>"><i class="fab fa-whatsapp" style="font-size: 0.7rem;"></i> WhatsApp</a>
    </div>
