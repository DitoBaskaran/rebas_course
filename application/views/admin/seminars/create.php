<div class="container-fluid px-0">
    <div class="d-flex align-items-center gap-2 mb-5">
        ...
        <div>
            ...
            <h1 class="display-6 fw-extrabold text-dark mb-0 lh-sm" style="letter-spacing: -0.03em;"><?php echo t('Buat Seminar Baru', 'Create New Seminar'); ?></h1>
        </div>
    </div>
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="bento-card animate-scale-in overflow-hidden">
                ...
                <?php endif; ?>
                <?php echo form_open_multipart('admin/create_seminar', array('class' => 'needs-validation')); ?>
                    <div class="card-body d-flex flex-column gap-4 p-4 p-xl-5">
                        ...
                        <div>
                            <div class="form-float">
                                <textarea name="description" rows="4" class="form-control" required placeholder=" " data-max-chars="2000"><?php echo set_value('description'); ?></textarea>
                                <label class="fl-label"><?php echo t('Deskripsi (ID)', 'Description (ID)'); ?> *</label>
                            </div>
                        </div>
                        <div>
                            <div class="form-float">
                                <textarea name="description_en" rows="4" class="form-control" placeholder=" " data-max-chars="2000"><?php echo set_value('description_en'); ?></textarea>
                        ...
                        <div class="row g-4">
                            <div class="col-md-4">
                                <div class="form-float">
                                    <input type="datetime-local" name="date_time" class="form-control" value="<?php echo set_value('date_time'); ?>" required placeholder=" ">
                            ...
                            <div class="col-md-3">
                                <div class="form-float">
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="price" class="form-control" value="<?php echo set_value('price', '0'); ?>" required placeholder=" ">
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-float">
                                    <input type="number" name="quota" class="form-control" value="<?php echo set_value('quota', '100'); ?>" required placeholder=" ">
                            ...
                            <div class="col-md-2">
                                <div class="form-float">
                                    <select name="language" class="form-select">
                                        <option value=""> </option>
                                        <option value="id" <?php echo set_select('language', 'id'); ?>>Indonesia</option>
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="form-float">
                                    <input type="url" name="location_link" class="form-control" value="<?php echo set_value('location_link'); ?>" placeholder=" ">
                            ...
                            <div class="col-md-6">
                                <div class="form-float">
                                    ...
                                    <label class="fl-label"><?php echo t('Poster', 'Poster'); ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex justify-content-end gap-2 px-4 px-xl-5 py-3 form-footer-sticky">
                        <a href="<?php echo base_url('admin/seminars'); ?>" class="btn btn-outline-secondary btn-sm rounded-pill px-4"><?php echo t('Batal', 'Cancel'); ?></a>
