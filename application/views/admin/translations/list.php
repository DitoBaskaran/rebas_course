<div class="container-fluid py-4" style="max-width: 1400px;">
    <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between mb-4 gap-3">
        <div>
            <div style="color: #f97316; font-weight: 700; font-size: 0.7rem; text-transform: uppercase; letter-spacing: 0.08em; margin-bottom: 0.15rem;">Localization</div>
            <h4 class="fw-extrabold mb-0" style="color: #1c1917; letter-spacing: -0.02em; font-size: 1.4rem;"><?php echo t('Terjemahan', 'Translations'); ?></h4>
    ...
    <div class="row g-3">
        <div class="col-lg-4">
            <div class="border rounded-3 p-3" style="border-color: #e7e5e4; border-radius: 12px;">
                <h5 class="fw-bold mb-4 d-flex align-items-center gap-2" style="color: #1c1917; font-size: 0.9rem;">
                    <span class="d-inline-flex align-items-center justify-content-center rounded-2" style="width: 32px; height: 32px; background: #fff7ed;"><i class="fas fa-plus" style="color: #f97316; font-size: 0.75rem;"></i></span>
                ...
                <?php echo form_open('admin/translations', array('class' => 'd-flex flex-column gap-3')); ?>
                    ...
                    <button type="submit" class="btn py-2 fw-bold rounded-pill d-flex align-items-center gap-1 justify-content-center" style="background: #f97316; color: #fff; font-size: 0.85rem;"><i class="fas fa-save" style="font-size: 0.7rem;"></i> <?php echo t('Simpan', 'Save'); ?></button>
                <?php echo form_close(); ?>
            </div>
        </div>
            ...
            <div class="border rounded-3" style="border-color: #e7e5e4; border-radius: 12px; overflow: hidden;">
                <div class="table-responsive p-0">
                    <table class="table mb-0" style="font-size: 0.8rem;">
                        <thead>
                            <tr>
                                <th style="font-weight: 600; color: #78716c; font-size: 0.68rem; border-color: #e7e5e4; padding: 0.7rem 1rem; background: #fafaf9; text-transform: uppercase; letter-spacing: 0.05em;">Key</th>
                                <th style="font-weight: 600; color: #78716c; font-size: 0.68rem; border-color: #e7e5e4; padding: 0.7rem 1rem; background: #fafaf9; text-transform: uppercase; letter-spacing: 0.05em;">Indonesia</th>
                                <th style="font-weight: 600; color: #78716c; font-size: 0.68rem; border-color: #e7e5e4; padding: 0.7rem 1rem; background: #fafaf9; text-transform: uppercase; letter-spacing: 0.05em;">English</th>
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <?php foreach ($translations as $t): ?>
                                    <tr>
                                        <td style="border-color: #f0eeeb; padding: 0.65rem 1rem; font-weight: 600; color: #1c1917; font-size: 0.78rem;"><?php echo htmlspecialchars($t->key); ?></td>
