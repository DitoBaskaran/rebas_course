<div class="container-fluid px-0">
    ...
    <div class="bento-card p-4 p-xl-5">
        <div class="d-flex flex-column gap-6" style="max-width: 800px; margin: 0 auto;">
            ...
            <!-- Intro -->
            <div class="p-4 rounded-3" style="background: #f8fafc; border-left: 4px solid #0d6efd;">
            ...
            <div class="section">
                <div class="d-flex align-items-center gap-2 mb-4 pb-2 border-bottom" style="border-color: #e2e8f0;">
                    <span style="display:flex;align-items:center;justify-content:center;width:32px;height:32px;background:#0d6efd;color:#fff;font-weight:700;font-size:0.85rem;border-radius:8px;flex-shrink:0;">1</span>
                    <h2 class="mb-0" style="font-size:1.15rem;font-weight:700;color:#0f172a;"><?php echo t('Bisnis & Strategi', 'Business & Strategy'); ?></h2>
                </div>
                <ul class="list-unstyled">
                    <li class="p-3 rounded-2 mb-2" style="background:#f8fafc; border:1px solid #e2e8f0;">
            ...
            <div class="section">
                <div class="d-flex align-items-center gap-2 mb-4 pb-2 border-bottom" style="border-color: #e2e8f0;">
                    <span style="display:flex;align-items:center;justify-content:center;width:32px;height:32px;background:#0d6efd;color:#fff;font-weight:700;font-size:0.85rem;border-radius:8px;flex-shrink:0;">2</span>
                    <h2 class="mb-0" style="font-size:1.15rem;font-weight:700;color:#0f172a;"><?php echo t('Teknikal & Produk', 'Technical & Product'); ?></h2>
                </div>
                <ul class="list-unstyled">
                    <li class="p-3 rounded-2 mb-2" style="background:#f8fafc; border:1px solid #e2e8f0;">
            ...
            <div class="section">
                <div class="d-flex align-items-center gap-2 mb-4 pb-2 border-bottom" style="border-color: #e2e8f0;">
                    <span style="display:flex;align-items:center;justify-content:center;width:32px;height:32px;background:#0d6efd;color:#fff;font-weight:700;font-size:0.85rem;border-radius:8px;flex-shrink:0;">3</span>
                    <h2 class="mb-0" style="font-size:1.15rem;font-weight:700;color:#0f172a;"><?php echo t('Konten & Akademik', 'Content & Academic'); ?></h2>
                </div>
                <ul class="list-unstyled">
                    <li class="p-3 rounded-2 mb-2" style="background:#f8fafc; border:1px solid #e2e8f0;">
            ...
            <div class="section">
                <div class="d-flex align-items-center gap-2 mb-4 pb-2 border-bottom" style="border-color: #e2e8f0;">
                    <span style="display:flex;align-items:center;justify-content:center;width:32px;height:32px;background:#0d6efd;color:#fff;font-weight:700;font-size:0.85rem;border-radius:8px;flex-shrink:0;">4</span>
                    <h2 class="mb-0" style="font-size:1.15rem;font-weight:700;color:#0f172a;"><?php echo t('Marketing & Sales', 'Marketing & Sales'); ?></h2>
                </div>
                <ul class="list-unstyled">
                    <li class="p-3 rounded-2 mb-2" style="background:#f8fafc; border:1px solid #e2e8f0;">
            ...
            <div class="section">
                <div class="d-flex align-items-center gap-2 mb-4 pb-2 border-bottom" style="border-color: #e2e8f0;">
                    <span style="display:flex;align-items:center;justify-content:center;width:32px;height:32px;background:#0d6efd;color:#fff;font-weight:700;font-size:0.85rem;border-radius:8px;flex-shrink:0;">5</span>
                    <h2 class="mb-0" style="font-size:1.15rem;font-weight:700;color:#0f172a;"><?php echo t('Legal & Administrasi', 'Legal & Admin'); ?></h2>
                </div>
                <ul class="list-unstyled">
                    <li class="p-3 rounded-2 mb-2" style="background:#f8fafc; border:1px solid #e2e8f0;">
            ...
            <div class="section">
                <div class="d-flex align-items-center gap-2 mb-4 pb-2 border-bottom" style="border-color: #e2e8f0;">
                    <span style="display:flex;align-items:center;justify-content:center;width:32px;height:32px;background:#0d6efd;color:#fff;font-weight:700;font-size:0.85rem;border-radius:8px;flex-shrink:0;">6</span>
                    <h2 class="mb-0" style="font-size:1.15rem;font-weight:700;color:#0f172a;"><?php echo t('Finansial & Akuntansi', 'Financial & Accounting'); ?></h2>
                </div>
                <ul class="list-unstyled">
                    <li class="p-3 rounded-2 mb-2" style="background:#f8fafc; border:1px solid #e2e8f0;">
