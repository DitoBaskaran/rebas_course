                    ...
                    <tbody>
                        <?php foreach ($coupons as $c): ?>
                            <tr>
                                ...
                                <td style="border-color: #f0eeeb; padding: 0.65rem 1rem;"><?php echo $c->is_active ? '<span class="px-2 py-1 rounded-pill fw-semibold" style="background: #f0fdfa; color: #10b981; font-size: 0.6rem;">Active</span>' : '<span class="px-2 py-1 rounded-pill fw-semibold" style="background: #f5f5f4; color: #78716c; font-size: 0.6rem;">Inactive</span>'; ?></td>
