        ...
        <?php foreach ($quizzes as $qz): ?>
            ...
            <div class="app-row app-row-card">
                <div class="app-row-head">
                    <div class="app-avatar" style="width:38px;height:38px;font-size:0.8rem;background:#E0F2F1;color:#009688;flex-shrink:0;"><i class="fas fa-pencil-alt"></i></div>
                    <div class="app-row-main">
                        <div class="app-row-title"><?php echo htmlspecialchars($qz->title); ?></div>
                        <div class="app-row-sub"><?php echo $qcount; ?> <?php echo t('soal', 'questions'); ?><span class="mob-sub-sep">·</span><?php echo $qz->time_limit > 0 ? $qz->time_limit . ' ' . t('menit', 'min') : '-'; ?></div>
                    </div>
