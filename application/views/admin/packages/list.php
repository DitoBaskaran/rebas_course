                    ...
                    <tbody>
                        <?php foreach ($packages as $p): ?>
                            <tr>
                                ...
                                <td style="border-color: #f0eeeb; padding: 0.65rem 1rem;"><span class="px-2 py-1 rounded-pill fw-semibold" style="background: <?php echo $p->access_scope === 'all' ? '#f0fdfa' : '#fff7ed'; ?>; color: <?php echo $p->access_scope === 'all' ? '#10b981' : '#f97316'; ?>; font-size: 0.6rem;"><?php if ($p->access_scope === 'all') echo t('Semua Konten', 'All Content'); elseif ($p->access_scope === 'category') echo t('Per Kategori', 'By Category'); else echo t('Per Kursus', 'By Course'); ?></span></td>
                                <td style="border-color: #f0eeeb; padding: 0.65rem 1rem;"><?php echo $p->is_active ? '<span class="px-2 py-1 rounded-pill fw-semibold" style="background: #f0fdfa; color: #10b981; font-size: 0.6rem;">Active</span>' : '<span class="px-2 py-1 rounded-pill fw-semibold" style="background: #f5f5f4; color: #78716c; font-size: 0.6rem;">Inactive</span>'; ?></td>
