<div class="container-fluid py-4" style="max-width: 1400px;">
    ...
    <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between mb-4 gap-3">
        <div>
            <div style="color: #0D1830; font-weight: 700; font-size: 0.7rem; text-transform: uppercase; letter-spacing: 0.08em; margin-bottom: 0.15rem;"><?php echo t('Konten', 'Content'); ?></div>
        ...
        <div class="d-flex gap-2">
            <button class="btn px-3 py-2 rounded-pill d-flex align-items-center gap-1" style="background: #E6EBEF; color: #57534e; font-size: 0.78rem;" id="viewToggle" onclick="toggleView()">
                <i class="fas fa-th" style="font-size: 0.7rem;"></i>
            </button>
            <a href="<?php echo base_url('admin/settings/general'); ?>" class="btn px-3 py-2 rounded-pill d-flex align-items-center gap-1" style="background: #E6EBEF; color: #57534e; font-size: 0.78rem;">
                <i class="fas fa-cog" style="font-size: 0.7rem;"></i>
            </a>
            <a href="<?php echo base_url('admin/create_course'); ?>" class="btn px-3 py-2 fw-semibold rounded-pill d-flex align-items-center gap-1" style="background: #0D1830; color: #fff; font-size: 0.78rem;">
    ...
    <div id="tableView">
        ...
        <div class="border rounded-3 p-5 text-center" style="border-color: #e7e5e4; border-radius: 12px;">
            ...
            <h6 class="fw-bold" style="color: #0D1830;"><?php echo t('Belum Ada Konten', 'No Content Yet'); ?></h6>
        ...
        <div class="border rounded-3" style="border-color: #e7e5e4; border-radius: 12px; overflow: hidden;">
            <div class="table-responsive p-0">
                <table class="table mb-0" style="font-size: 0.8rem;" id="courseTable">
                    <thead>
                        <tr>
                            <th style="font-weight: 600; color: #78716c; font-size: 0.68rem; border-color: #e7e5e4; padding: 0.7rem 1rem; background: #E6EBEF; text-transform: uppercase; letter-spacing: 0.05em; width: 72px;"><?php echo t('Cover', 'Cover'); ?></th>
                            <th style="font-weight: 600; color: #78716c; font-size: 0.68rem; border-color: #e7e5e4; padding: 0.7rem 1rem; background: #E6EBEF; text-transform: uppercase; letter-spacing: 0.05em;"><?php echo t('Judul', 'Title'); ?></th>
                            ...
                            <th style="font-weight: 600; color: #78716c; font-size: 0.68rem; border-color: #e7e5e4; padding: 0.7rem 1rem; background: #E6EBEF; text-transform: uppercase; letter-spacing: 0.05em;"><?php echo t('Kategori', 'Category'); ?></th>
                            <th style="font-weight: 600; color: #78716c; font-size: 0.68rem; border-color: #e7e5e4; padding: 0.7rem 1rem; background: #E6EBEF; text-transform: uppercase; letter-spacing: 0.05em;"><?php echo t('Instruktur', 'Instructor'); ?></th>
                            ...
                            <th style="font-weight: 600; color: #78716c; font-size: 0.68rem; border-color: #e7e5e4; padding: 0.7rem 1rem; background: #E6EBEF; text-transform: uppercase; letter-spacing: 0.05em;"><?php echo t('Harga', 'Price'); ?></th>
                            <th style="font-weight: 600; color: #78716c; font-size: 0.68rem; border-color: #e7e5e4; padding: 0.7rem 1rem; background: #E6EBEF; text-transform: uppercase; letter-spacing: 0.05em; text-align: center;"><?php echo t('Materi', 'Lessons'); ?></th>
                            <th style="font-weight: 600; color: #78716c; font-size: 0.68rem; border-color: #e7e5e4; padding: 0.7rem 1rem; background: #E6EBEF; text-transform: uppercase; letter-spacing: 0.05em; text-align: center; width: 100px;"><?php echo t('Aksi', 'Action'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach ($courses as $course): ?>
                            <tr data-status="<?php echo $course->status; ?>">
                                ...
                                <td style="border-color: #f0eeeb; padding: 0.55rem 1rem; font-weight: 700; color: #0D1830; font-size: 0.82rem;">
                                    <?php echo htmlspecialchars($course->title); ?>
                                    <?php if ($course->featured): ?><i class="fas fa-star" style="color: #FBBF24; font-size: 0.6rem; margin-left: 0.25rem;"></i><?php endif; ?>
                                    <?php if ($course->price == 0): ?><span class="px-2 py-1 rounded-pill fw-semibold ms-1" style="background: #E0F2F1; color: #009688; font-size: 0.6rem;"><?php echo t('Gratis', 'Free'); ?></span><?php endif; ?>
                                </td>
                                <td style="border-color: #f0eeeb; padding: 0.55rem 1rem;">
                                    <span class="px-2 py-1 rounded-pill fw-semibold mb-1 d-inline-block" style="background: #fff7ed; color: #0D1830; font-size: 0.6rem;"><?php echo content_type_label($course->content_type); ?></span>
                                    <span class="px-2 py-1 rounded-pill fw-semibold" style="background: #E6EBEF; color: #57534e; font-size: 0.6rem;"><?php echo skill_level_label($course->skill_level); ?></span>
                                </td>
                                ...
                                <td style="border-color: #f0eeeb; padding: 0.55rem 1rem;">
                                    <?php if ($course->status === 'published'): ?>
                                        <span class="px-2 py-1 rounded-pill fw-semibold" style="background: #E0F2F1; color: #009688; font-size: 0.62rem;">
                                            <i class="fas fa-check-circle me-1" style="font-size: 0.5rem;"></i> <?php echo t('Published', 'Published'); ?>
                                        </span>
                                    <?php elseif ($course->status === 'draft'): ?>
                                        <span class="px-2 py-1 rounded-pill fw-semibold" style="background: #fff7ed; color: #0D1830; font-size: 0.62rem;">
                                            <i class="fas fa-pencil-alt me-1" style="font-size: 0.5rem;"></i> <?php echo t('Draft', 'Draft'); ?>
                                        </span>
                                    <?php else: ?>
                                        <span class="px-2 py-1 rounded-pill fw-semibold" style="background: #E6EBEF; color: #78716c; font-size: 0.62rem;">
                                            <i class="fas fa-archive me-1" style="font-size: 0.5rem;"></i> <?php echo t('Archived', 'Archived'); ?>
                                        </span>
                                    <?php endif; ?>
                                </td>
                                <td style="border-color: #f0eeeb; padding: 0.55rem 1rem; font-weight: 700; color: #0D1830; font-size: 0.8rem;">
                                    <?php echo $course->price > 0 ? 'Rp ' . number_format($course->price, 0, ',', '.') : '<span style="color: #009688;">' . t('Gratis', 'Free') . '</span>'; ?>
                                </td>
                                <td style="border-color: #f0eeeb; padding: 0.55rem 1rem;">
                                    <div class="d-flex gap-1 justify-content-center">
                                        <a href="<?php echo base_url('admin/lessons/' . $course->id); ?>" class="btn btn-sm rounded-pill px-2 fw-semibold d-inline-flex align-items-center gap-1" style="background: #E6EBEF; color: #57534e; font-size: 0.68rem;" title="<?php echo t('Materi', 'Lessons'); ?>">
                                            <i class="fas fa-list" style="font-size: 0.65rem;"></i>
                                        </a>
                                        <a href="<?php echo base_url('quiz/admin_quizzes/' . $course->id); ?>" class="btn btn-sm rounded-pill px-2 fw-semibold d-inline-flex align-items-center gap-1" style="background: #E6EBEF; color: #57534e; font-size: 0.68rem;" title="<?php echo t('Quiz', 'Quizzes'); ?>">
                                            <i class="fas fa-pencil-alt" style="font-size: 0.65rem;"></i>
                                        </a>
                                        <a href="<?php echo base_url('admin/assignments/' . $course->id); ?>" class="btn btn-sm rounded-pill px-2 fw-semibold d-inline-flex align-items-center gap-1" style="background: #E6EBEF; color: #57534e; font-size: 0.68rem;" title="<?php echo t('Tugas', 'Assignments'); ?>">
                                ...
                                <td style="border-color: #f0eeeb; padding: 0.55rem 1rem;">
                                    <div class="d-flex justify-content-center gap-1">
                                        <a href="<?php echo base_url('admin/edit_course/' . $course->id); ?>" class="btn btn-sm rounded-pill px-2 fw-semibold d-inline-flex align-items-center" style="background: #0D1830; color: #fff; font-size: 0.68rem;" title="<?php echo t('Edit', 'Edit'); ?>">
                    ...
                    <div class="col-md-6 col-lg-4" data-status="<?php echo $course->status; ?>">
                        <div class="border rounded-3 h-100 d-flex flex-column" style="border-color: #e7e5e4; border-radius: 12px; overflow: hidden;">
                            ...
                            <div class="p-3 d-flex flex-column flex-fill">
                                ...
                                <h6 class="fw-bold mb-2" style="color: #0D1830; font-size: 0.85rem; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">
                                    <?php echo htmlspecialchars($course->title); ?>
                                </h6>
                                ...
                                <div class="d-flex align-items-center justify-content-between pt-2" style="border-top: 1px solid #f0eeeb;">
                                    <span class="fw-bold" style="color: #0D1830; font-size: 0.82rem;">
                                        <?php echo $course->price > 0 ? 'Rp ' . number_format($course->price, 0, ',', '.') : '<span style="color: #009688;">' . t('Gratis', 'Free') . '</span>'; ?>
                                    </span>
                                    <div class="d-flex gap-1">
                                        <a href="<?php echo base_url('admin/edit_course/' . $course->id); ?>" class="btn btn-sm rounded-pill px-2 fw-semibold d-inline-flex align-items-center" style="background: #0D1830; color: #fff; font-size: 0.68rem;">
                                            <i class="fas fa-edit" style="font-size: 0.65rem;"></i>
                                        </a>
