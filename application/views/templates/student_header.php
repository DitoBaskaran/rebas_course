...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/bisatuntas.css?v=10'); ?>">
    <!-- BISATUNTAS Colorful Playful Override -->
    <link rel="stylesheet" href="<?php echo base_url('assets/css/bisatuntas-playful-alt.css?v=10'); ?>">
    <!-- SweetAlert2 -->
