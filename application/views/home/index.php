...
<?php $cat_colors = array('#059669', '#f59e0b', '#6366f1', '#ec4899', '#0ea5e9', '#8b5cf6', '#f43f5e', '#10b981'); ?>
...
<section class="lp-section">
    <div class="container">
        ...
        <div class="row g-3">
            <div class="col-md-6 col-lg-4"><div class="lp-why"><div class="lp-why-icon" style="--wi:#059669;background:rgba(5,150,105,0.1);color:#059669;"><i class="fas fa-sitemap"></i></div><h6><?php echo t('Kurikulum Terstruktur', 'Structured Curriculum'); ?></h6><p><?php echo t('Alur belajar yang jelas dari pemula hingga mahir.', 'Clear learning paths from beginner to advanced.'); ?></p></div></div>
            <div class="col-md-6 col-lg-4"><div class="lp-why"><div class="lp-why-icon" style="--wi:#6366f1;background:rgba(99,102,241,0.1);color:#6366f1;"><i class="fas fa-user-tie"></i></div><h6><?php echo t('Mentor Praktisi', 'Practitioner Mentors'); ?></h6><p><?php echo t('Belajar langsung dari praktisi industri berpengalaman.', 'Learn directly from experienced industry practitioners.'); ?></p></div></div>
            <div class="col-md-6 col-lg-4"><div class="lp-why"><div class="lp-why-icon" style="--wi:#f59e0b;background:rgba(245,158,11,0.1);color:#f59e0b;"><i class="fas fa-project-diagram"></i></div><h6><?php echo t('Project-Based', 'Project-Based'); ?></h6><p><?php echo t('Praktik langsung dan bangun portofolio untuk karir.', 'Practice directly and build a portfolio for your career.'); ?></p></div></div>
        ...
        <div class="row g-3 justify-content-center">
            <div class="col-md-4">
                <div class="lp-testi">
                    ...
                    <div class="lp-testi-by"><span class="lp-avatar" style="background:#059669;">RK</span><div><strong>Rina Kusuma</strong><small><?php echo t('Siswa Web Development', 'Web Development Student'); ?></small></div></div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="lp-testi">
                    ...
                    <div class="lp-testi-by"><span class="lp-avatar" style="background:#6366f1;">DP</span><div><strong>Dimas Pratama</strong><small><?php echo t('Siswa Program Mentorship', 'Mentorship Program Student'); ?></small></div></div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="lp-testi">
                    ...
                    <div class="lp-testi-by"><span class="lp-avatar" style="background:#f59e0b;">SI</span><div><strong>Sari Indah</strong><small><?php echo t('Siswa Digital Marketing', 'Digital Marketing Student'); ?></small></div></div>
                </div>
            </div>
        </div>
    </div>
...
<style>
/* ===== Landing redesign (lp-) ===== */
.lp-hero{position:relative;overflow:hidden;background:linear-gradient(160deg,#0b3d2e 0%,#065f46 40%,#059669 100%);padding:4.5rem 0 4rem;color:#fff;}
...
.lp-btn-primary{background:#fff;color:#065f46;box-shadow:0 8px 24px rgba(0,0,0,0.2);}
.lp-btn-primary:hover{transform:translateY(-2px);box-shadow:0 12px 30px rgba(0,0,0,0.25);color:#065f46;}
...
.lp-btn-amber{background:linear-gradient(135deg,#fbbf24,#f59e0b);color:#0b3d2e;box-shadow:0 10px 28px rgba(251,191,36,0.4);}
.lp-btn-amber:hover{transform:translateY(-2px);box-shadow:0 14px 34px rgba(251,191,36,0.5);color:#0b3d2e;}
...
.lp-hero-emoji{width:52px;height:52px;border-radius:16px;background:linear-gradient(135deg,#fbbf24,#f59e0b);display:flex;align-items:center;justify-content:center;font-size:1.3rem;color:#0b3d2e;box-shadow:0 8px 20px rgba(251,191,36,0.4);}
...
.lp-hp-bar div{height:100%;border-radius:99px;background:linear-gradient(90deg,#fbbf24,#f59e0b);}
...
.lp-section-tint{background:#f0fdfa;}
...
.lp-kicker{display:inline-block;font-size:0.68rem;font-weight:700;text-transform:uppercase;letter-spacing:0.1em;color:#059669;margin-bottom:0.35rem;}
.lp-kicker-light{color:#fbbf24;}
.lp-section-title{font-size:1.55rem;font-weight:800;letter-spacing:-0.03em;color:#171717;margin:0;}
.lp-section-desc{font-size:0.85rem;color:#737373;margin:0.25rem 0 0;}
.lp-link-all{font-size:0.82rem;font-weight:700;color:#059669;text-decoration:none;display:inline-flex;align-items:center;gap:6px;white-space:nowrap;}
.lp-link-all:hover{color:#047857;text-decoration:underline;}
/* kategori */
...
.lp-cat-info strong{display:block;font-size:0.82rem;font-weight:700;color:#171717;margin-bottom:0.1rem;}
...
.lp-cat-all{background:#171717;border-color:#171717;}
...
.lp-card-meta i{font-size:0.55rem;margin-right:2px;color:#059669;}
.lp-card-title{font-size:0.84rem;font-weight:700;color:#171717;margin:0 0 0.5rem;line-height:1.35;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;}
.lp-card-foot{display:flex;align-items:center;justify-content:space-between;font-size:0.82rem;font-weight:700;color:#171717;margin-top:auto;}
.lp-price{color:#171717;}
.lp-free{color:#059669;font-weight:600;}
.lp-learn{width:28px;height:28px;border-radius:8px;background:#f0fdf4;color:#059669;display:inline-flex;align-items:center;justify-content:center;font-size:0.65rem;transition:all 0.2s;}
.lp-card:hover .lp-learn{background:#059669;color:#fff;}
.lp-card-badge{position:absolute;top:8px;left:8px;background:rgba(255,255,255,0.92);backdrop-filter:blur(4px);color:#171717;font-size:0.6rem;font-weight:700;padding:0.2rem 0.5rem;border-radius:6px;}
...
.lp-why h6{font-size:0.88rem;font-weight:700;color:#171717;margin:0 0 0.35rem;}
.lp-why p{font-size:0.78rem;color:#737373;margin:0;line-height:1.55;}
/* steps dark */
.lp-dark{background:linear-gradient(160deg,#0b3d2e 0%,#065f46 60%,#047857 100%);position:relative;overflow:hidden;}
...
.lp-step-num{position:absolute;top:0;left:50%;transform:translateX(-50%);width:30px;height:30px;border-radius:50%;background:#fbbf24;color:#0b3d2e;font-weight:800;font-size:0.8rem;display:flex;align-items:center;justify-content:center;box-shadow:0 0 0 6px rgba(251,191,36,0.15);}
...
.lp-stars i{font-size:0.75rem;color:#f59e0b;}
...
.lp-testi-by strong{display:block;font-size:0.8rem;color:#171717;}
.lp-testi-by small{font-size:0.68rem;color:#9ca3af;}
/* CTA */
.lp-cta{position:relative;overflow:hidden;padding:3.2rem 2.5rem;border-radius:22px;background:linear-gradient(135deg,#0b3d2e 0%,#065f46 50%,#059669 100%);text-align:center;box-shadow:0 24px 60px rgba(5,150,105,0.25);}
