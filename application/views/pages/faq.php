        ...
        <div class="col-lg-8">
            <div class="accordion" id="faqAccordion">
                <?php $faqs = array(
                    ...
                    array('q' => 'Apa saja metode pembayaran?', 'q_en' => 'What payment methods are available?', 'a' => 'Kami menerima transfer bank manual dan pembayaran online melalui QRIS, Virtual Account, GoPay, OVO, dan Kartu Kredit.', 'a_en' => 'We accept manual bank transfer and online payments via QRIS, Virtual Account, GoPay, OVO, and Credit Card.'),
