...
<head>
    ...
    <style>
        ...
        .exception { text-align: left; margin-top: 1rem; padding: 1rem; background: #f8fafc; border-radius: 6px; font-size: 0.8rem; color: var(--gray-500); overflow-x: auto; }
    </style>
</head>
<body>
    <div style="text-align: center; padding: 2rem; max-width: 520px;">
        <div class="card" style="padding: 3rem 2rem;">
            ...
            <h2 style="font-weight: 800; color: var(--gray-700); margin: 0 0 0.5rem;">Terjadi Kesalahan</h2>
            <p style="color: var(--gray-500); font-size: 0.9rem; margin-bottom: 1.5rem;">Maaf, terjadi kesalahan yang tidak terduga. Tim kami telah diberitahu.</p>
            <?php if (defined('SHOW_DEBUG_BACKTRACE') && SHOW_DEBUG_BACKTRACE === TRUE): ?>
                <div class="exception"><?php echo $message; ?><?php echo $exception->getTraceAsString(); ?></div>
            <?php endif; ?>
