...
<body>
    <div style="text-align: center; padding: 2rem; max-width: 520px;">
        <div class="card" style="padding: 3rem 2rem;">
            ...
            <h2 style="font-weight: 800; color: var(--gray-700); margin: 0 0 0.5rem;">Database Error</h2>
            <p style="color: var(--gray-500); font-size: 0.9rem; margin-bottom: 2rem;">Terjadi kesalahan pada database. Silakan coba lagi nanti.</p>
