...
<div style="border-bottom: 1px solid #e5e5e5;">
    <div class="container" style="padding-top: 2rem; padding-bottom: 1.5rem; max-width: 960px;">
        <div class="text-center mb-4">
            <span class="px-3 py-1 rounded-pill fw-semibold mb-3 d-inline-block" style="background: #0D1830; color: #fff; font-size: 0.72rem;">EVENTS</span>
            <h1 class="fw-extrabold mb-2" style="font-size: 1.6rem; letter-spacing: -0.02em; color: #0D1830;">
...
<div class="container" style="max-width: 960px; padding-top: 1.5rem; padding-bottom: 3rem;">
    <?php if (empty($seminars)): ?>
        <div class="text-center py-5">
            ...
            <h5 class="fw-bold" style="color: #0D1830;"><?php echo t('Belum Ada Seminar', 'No Seminars Yet'); ?></h5>
                        ...
                        <div class="card h-100" style="border: 1px solid #e5e5e5; border-radius: 12px; transition: all 0.15s;">
                            ...
                            <div class="position-relative overflow-hidden" style="aspect-ratio: 16/9; border-radius: 12px 12px 0 0;">
                                ...
                                <div class="position-absolute top-0 start-0 m-2">
                                    <span class="px-2 py-1 rounded-pill fw-semibold" style="background: #0D1830; color: #fff; font-size: 0.65rem;">
                                ...
                                <?php if ($seminar->price > 0): ?>
                                    <div class="position-absolute top-0 end-0 m-2">
                                        <span class="px-2 py-1 rounded-pill fw-bold" style="background: #FBBF24; color: #0D1830; font-size: 0.65rem;">
                            ...
                            <div class="card-body p-3 d-flex flex-column">
                                ...
                                <!-- Title -->
                                <h6 class="fw-bold mb-2 lh-sm" style="color: #0D1830; font-size: 0.875rem; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">
                                ...
                                <div class="d-flex align-items-center gap-2 mb-2 py-2 px-3 rounded-3" style="background: #fafafa;">
                                    ...
                                    <div>
                                        <div class="fw-semibold" style="color: #0D1830; font-size: 0.75rem;"><?php echo htmlspecialchars($seminar->speaker_name); ?></div>
