    ...
    <div class="row g-3 mb-4">
        <div class="col-md-6">
            <div class="border rounded-3 p-3 h-100" style="border-color: #e7e5e4; border-radius: 12px;">
                <h6 class="fw-bold mb-2" style="color: #1c1917; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.05em;">
                ...
                <div class="d-flex flex-column gap-2" style="font-size: 0.8rem;">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <span class="fw-semibold" style="color: #1c1917;"><?php echo date('d M Y H:i', strtotime($transaction->created_at)); ?></span>
                    </div>
                    <div class="d-flex justify-content-between">
                        <span style="color: #78716c;"><?php echo t('Nominal', 'Amount'); ?></span>
                        <span class="fw-bold" style="color: #1c1917; font-size: 1rem;">
            ...
            <div class="border rounded-3 p-3 h-100" style="border-color: #e7e5e4; border-radius: 12px;">
                ...
                <div class="d-flex flex-column gap-2" style="font-size: 0.8rem;">
                    <div class="d-flex justify-content-between">
                        ...
                        <span class="fw-semibold" style="color: #1c1917;">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <span class="fw-semibold" style="color: #1c1917;"><?php echo $transaction->payment_channel; ?></span>
                    </div>
                    <?php endif; ?>
                    <?php if ($transaction->gateway_tx_id): ?>
                    <div class="d-flex justify-content-between">
                        <span style="color: #78716c;"><?php echo t('ID Gateway', 'Gateway ID'); ?></span>
                        <span class="fw-semibold" style="color: #1c1917; font-family: monospace; font-size: 0.72rem;">
    ...
    <div class="border rounded-3 p-3 mb-4" style="border-color: #e7e5e4; border-radius: 12px;">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div class="flex-fill min-w-0">
                <div class="fw-bold" style="color: #1c1917; font-size: 0.85rem;">
