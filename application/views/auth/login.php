<?php
$page_title = t('Halo lagi!', 'Welcome Back!');
$page_subtitle = t('Masuk ke akunmu dan lanjutkan belajar', 'Sign in and continue learning');
$submit_text = t('Masuk', 'Sign In');
$form_action = 'auth/login';
$google_btn_text = t('Lanjutkan dengan Google', 'Continue with Google');
$footer_text = t('Belum punya akun?', "Don't have an account?");
$footer_link_text = t('Daftar Gratis', 'Register Free');
$footer_link_url = base_url('auth/register');
?>
